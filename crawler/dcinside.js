...
const GALLERY_URL  = 'https://gall.dcinside.com/board/lists?id=lineage';
...
async function crawlDCInside() {
  ...
  try {
    ...
    console.log(`[DC인사이드] ${posts.length}개 수집 (본문 포함)`);
  } catch (err) {
    console.error('[DC인사이드 크롤링 오류]', err.message);
  }
  return posts;
}

module.exports = { crawlDCInside };
