...
const BOARD_URL = 'https://www.inven.co.kr/board/aion2/6388';
...
async function crawlAion2Inven() {
  const posts = [];
  try {
    ...
    console.log(`[아이온2 인벤] ${posts.length}개 수집 (본문 포함)`);
  } catch (err) {
    console.error('[아이온2 인벤 크롤링 오류]', err.message);
  }
  return posts;
}

module.exports = { crawlAion2Inven };
