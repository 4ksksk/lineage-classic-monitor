...
push 작성 규칙:
- 반드시 이번에 수집된 리니지클래식 실제 이슈·업데이트·시세 내용만을 기반으로 작성할 것
- 없는 이벤트·혜택을 사실인 것처럼 표현하거나 과장·허위 내용 절대 금지
- 이 플랫폼은 판매자와 구매자를 연결하는 중개 서비스임을 인지하고, 중개 플랫폼에 맞는 문구로 작성
- 해당 이슈로 인해 유저가 자연스럽게 시세 확인·아이템 거래에 관심을 갖도록 심리적으로 유도할 것
