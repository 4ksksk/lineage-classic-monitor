...
- 플랫폼이 어떤 것을 직접 제공하거나 주최하는 주체처럼 작성하지 말 것
- 불법·부정 이슈는 광고 소재로 절대 사용 금지
- 카피의 핵심 목적은 유저가 시세 확인·매물 탐색·거래를 위해 플랫폼에 접속하도록 유도하는 것임을 반드시 인지할 것
- 게임사 공지처럼 인게임 플레이나 게임 내 행동을 유도하는 문체는 절대 금지
- 제목은 수집된 이슈가 아이템 시세나 거래에 미치는 영향을 중심으로 유저의 관심을 끌 것
- 내용은 지금 플랫폼에 접속해야 하는 구체적이고 납득 가능한 이유를 제시할 것
- 수집된 이슈와 플랫폼 접속 사이의 연결고리가 자연스럽고 논리적으로 이어지도록 작성할 것
- 말투는 정보를 먼저 알게 된 게임 유저가 다른 유저에게 귀띔해주는 느낌으로 가볍고 친근하게 작성할 것
- 모호한 행동 유도 문구나 근거 없는 마케팅 관용 문구는 일체 사용 금지
- 이모지는 1~2개, 문장 흐름에 자연스럽게 삽입할 것
